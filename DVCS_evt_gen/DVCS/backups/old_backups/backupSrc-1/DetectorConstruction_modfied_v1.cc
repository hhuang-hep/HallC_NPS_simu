...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  G4cout<<"Construction of the world"<<G4endl;
/*
  ...
  */
  ...
  //G4Box* sSweepingMagnet_4_2_before_sub = new G4Box("SweepingMagnet_4_2_before_sub_sol", 0.5*32*inch, 0.5*56*inch, 0.5*4*inch);
  //G4Box* sSweepingMagnet_4_2_hole1 = new G4Box("SweepingMagnet_4_2_hole1_sol", (0.5*7.8 + 1/*extra cutting*/)*inch, 0.5*2.4*inch,  (0.5*4 + 1/*extra cutting*/)*inch);
  //G4Box* sSweepingMagnet_4_2_hole2 = new G4Box("SweepingMagnet_4_2_hole2_sol", 0.5*7.4*inch, 0.5*16.8*inch, (0.5*4 + 1/*extra cutting*/)*inch);
  ...
  //G4Box* sSweepingMagnet_4_3_before_sub = new G4Box("SweepingMagnet_4_3_before_sub_sol", 0.5*27*inch, 0.5*56*inch, 0.5*3*inch);
  //G4Box* sSweepingMagnet_4_3_hole1 = new G4Box("SweepingMagnet_4_3_hole1_sol", (0.5*6 + 1/*extra cutting*/)*inch, 0.5*2.4*inch,  (0.5*3 + 1/*extra cutting*/)*inch);
  //G4Box* sSweepingMagnet_4_3_hole2 = new G4Box("SweepingMagnet_4_3_hole2_sol", 0.5*7.4*inch, 0.5*15.225*inch, (0.5*3 + 1/*extra cutting*/)*inch);
