...
target_gen_proc_type = dvcsGlobals::target_gen_proc_type; // target type: p, n or d
  ...
  if( target_gen_proc_type == 0 || target_gen_proc_type == 1 || target_gen_proc_type ==2)
    {
  if(target_gen_proc_type == 0) {M_targ = 0.9383;} // proton
  else if( target_gen_proc_type == 1 ) {M_targ = 0.939565378;} // neutron
  else if( target_gen_proc_type == 2 ) {M_targ = 1.875612859;} // deuteron
    }
  else
    {
