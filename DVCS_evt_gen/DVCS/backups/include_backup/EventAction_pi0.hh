...
public:
    ...
    void DefinePrimaries(TLorentzVector*, TLorentzVector*, TLorentzVector*, TLorentzVector*, TLorentzVector*, G4double);
...
private:
    ...
    TLorentzVector* L_calo_phot1;
    TLorentzVector* L_calo_phot2;
